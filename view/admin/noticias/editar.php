<h3>
    ...
    <?php } else { ?>
        <span>Noticia noticia</span>
    <?php } ?>
</h3>
<div class="row">
    <?php $id = ($datos->id) ? $datos->id : "nuevo" ?>
    <form class="col s12" method="POST" enctype="multipart/form-data" action="<?php echo $_SESSION['home'] ?>public/admin/noticias/editar/<?php echo $id ?>">
        <div class="col m12 l6">
            <div class="row">
                ...
                <div class="input-field col s12">
                    <?php $datat = ($datos->fecha) ? date("d-m-Y", strtotime($datos->datat)) : date("d-m-Y") ?>
